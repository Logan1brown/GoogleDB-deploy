...
# NOTE: This import is no longer valid as SuggestionAnalyzer has been merged into OptimizerView
    ...
    def _run_analysis(self, state: Dict):
        ...
        try:
            ...
            with st.spinner("Analyzing concept..."):
                # Use FieldManager to normalize criteria
                normalized_criteria = self.optimizer.field_manager.normalize_criteria(criteria)
